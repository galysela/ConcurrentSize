...
/**
 *  This file is a variant of BST.java which applies the linearization point of a delete at its marking step.
 */

/**
 *  This is a variant of an implementation of the non-blocking, concurrent binary search tree of
...
public class BSTTransformedToRemoveLpAtMark<K extends Comparable<? super K>, V> {
    //--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
    ...
    public BSTTransformedToRemoveLpAtMark() {
