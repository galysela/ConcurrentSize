/**
 *  This file is based on https://bitbucket.org/trbot86/implementations/src/master/java/src/adapters/AbstractAdapter.java
 */
...
public abstract class AbstractAdapter<K> {
    ...
    public abstract boolean insert(final K key);
